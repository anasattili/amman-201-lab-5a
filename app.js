...
function multiply(a, b) { //eslint-disable-line
    var mult = a * b;
    // `The sum of 4 and 7 is 11.`
    var result = `The product of ${5} and ${9} is ${mult}.`;
    return [mult, result];
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    var sumMsg = `${a} and ${b} and ${c} sum to ${sum2}.`;
    var multMsg = `The product of ${a} and ${b} and ${c} is ${mult2}.`;
    return [sum2, mult2, sumMsg, multMsg];
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    for (var i=0; i <multArr.length; i++) {
       multi*= multArr[i]; 
            ...
            var multiRes= `The numbers 2,3,4 have a product of ${24}.`
            return [multi,multiRes];
}
